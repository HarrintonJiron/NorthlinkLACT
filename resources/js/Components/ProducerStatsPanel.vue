...
const emit = defineEmits(['registrar-cliente'])
...
const withoutRoute = computed(() => props.stats.without_route || 0)
    ...
    <div class="relative grid grid-cols-1 lg:grid-cols-12 gap-6 p-6 lg:p-7">
      <div class="lg:col-span-5 flex flex-col justify-between min-h-[220px]">
        <div>
          ...
          <h2 class="mt-1 text-4xl lg:text-5xl font-display font-bold text-[#1D1D1F] tracking-tight">Productores</h2>
          <p class="mt-3 text-sm text-[#8E8E93]">
            {{ total }} clientes · {{ active }} activos · {{ inactive }} inactivos · {{ withoutRoute }} sin ruta
          </p>
        </div>
        <div class="mt-6">
          <button
          ...
          >
            <p class="text-sm font-semibold text-[#1D1D1F]">Registrar cliente</p>
            <p class="text-[11px] text-[#6E6E73]">Asignar a una ruta</p>
          </button>
        </div>
      </div>
      ...
      <div class="lg:col-span-3 flex flex-col">
        ...
        <div class="mt-3 space-y-1.5 text-xs">
          ...
          <div class="grid grid-cols-[auto_1fr_auto_auto] gap-x-3 items-center text-[#1D1D1F]">
            ...
            <span>Sin ruta</span>
            <span class="tabular-nums">{{ withoutRoute }}</span>
            <span class="text-[#8E8E93] w-10 text-right">{{ percent(withoutRoute) }}%</span>
          </div>
        </div>
      </div>
